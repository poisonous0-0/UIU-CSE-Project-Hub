<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST"){
        ...
        $admin_phoneNumber = $_POST['phone_number'];
        $password = $_POST['password'];
        $confirm_password = $_POST['confirm_password'];

        if($password == $confirm_password){
            $query1 = "INSERT INTO admin_information (name, email, phone_number) VALUES ('$admin_name','$admin_email','$admin_phoneNumber')";
            $query2 = "INSERT INTO login_credentials (email, password, usertype) VALUES ('$admin_email','$password', 'admin')";
...
<head>
    ...
    <link rel="stylesheet" href="/SignupPanel/signup_panel_admin_style.css">
